...
export default function CopyLink({ handleCopyToClipboard }) {
    return (
        <div className="fixed bottom-4 right-4 text-sm flex text-center mt-3 bg-[#323638] rounded-md p-2 border border-white items-center justify-center w-[5rem] opacity-70 hover:opacity-100 transition-all duration-150 ease-in-out">
